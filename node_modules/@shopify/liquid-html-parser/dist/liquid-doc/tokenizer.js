...
exports.ParamTokenType = exports.LiquidDocTokenType = void 0;
exports.tokenizeLiquidDoc = tokenizeLiquidDoc;
exports.tokenizeParamContent = tokenizeParamContent;
var LiquidDocTokenType;
(function (LiquidDocTokenType) {
    /** `@param`, `@example`, `@description`, `@prompt`, etc. */
    LiquidDocTokenType["Annotation"] = "Annotation";
    /** A contiguous run of text on a single line (leading whitespace stripped). */
    LiquidDocTokenType["TextLine"] = "TextLine";
    /** A newline character (or \r\n). */
    LiquidDocTokenType["Newline"] = "Newline";
    /** End of input sentinel. */
    LiquidDocTokenType["EndOfInput"] = "EndOfInput";
})(LiquidDocTokenType || (exports.LiquidDocTokenType = LiquidDocTokenType = {}));
/** Tokens for the @param sub-grammar. */
var ParamTokenType;
(function (ParamTokenType) {
    /** `{type}` — a type annotation inside braces. */
    ParamTokenType["Type"] = "Type";
    /** `[name]` — an optional param name in square brackets. */
    ParamTokenType["OptionalName"] = "OptionalName";
    /** A bare word. */
    ParamTokenType["Word"] = "Word";
    /** `-` dash separator. */
    ParamTokenType["Dash"] = "Dash";
    /** Remaining text after name/dash. */
    ParamTokenType["Text"] = "Text";
    /** End sentinel. */
    ParamTokenType["EndOfInput"] = "EndOfInput";
})(ParamTokenType || (exports.ParamTokenType = ParamTokenType = {}));
/**
 ...
 */
function tokenizeLiquidDoc(body, startOffset) {
    const tokens = [];
    let pos = 0;
 ...
 */
function tokenizeParamContent(text, startOffset) {
    const tokens = [];
    let pos = 0;
