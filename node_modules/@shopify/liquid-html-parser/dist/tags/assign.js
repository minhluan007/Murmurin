...
exports.assignTag = {
    ...
    parse(_name, markup, _parser) {
        ...
        let name;
        if (markup.isLax()) {
            const raw = markup.consumeRawUntil(tokenizer_1.MarkupTokenType.Equality);
            ...
            name = markup.consume(tokenizer_1.MarkupTokenType.Id).value;
        }
        const eqToken = markup.consume(tokenizer_1.MarkupTokenType.Equality);
        if (eqToken.value !== '=') {
