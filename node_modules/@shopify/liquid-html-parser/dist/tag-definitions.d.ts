...
export interface Parser {
    parseLiquidStatement(tagName: string, markupString: string, startOffset: number, ctx: LiquidLineContext): LiquidStatement;
}
...
export type TagDefinition<M = unknown> = TagDefinitionBlock<M> | TagDefinitionTag<M> | TagDefinitionRaw<M> | TagDefinitionHybrid<M>;
